...
export default function LogInUser() {
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-8 rounded-lg shadow">
          <h1 className="text-2xl font-bold text-blue-700 mb-6 text-center">Login as User</h1>
          ...
          <div className="mt-4 text-center">
            <p>New account? <Link to={"/user/register"} className="text-blue-600 hover:underline">Register</Link></p>
          </div>
        </div>
  )
}

...
export default function RegisterAdmin() {
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-8 rounded-lg shadow">
      <h1 className="text-2xl font-bold text-blue-700 mb-6 text-center">Admin Register</h1>
      ...
      <div className="mt-4 text-center">
        <p>Already have an account? <Link to={"/admin/login"} className="text-blue-600 hover:underline">LogIn</Link></p>
      </div>
    </div>
  )
}
